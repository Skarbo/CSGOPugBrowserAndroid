...
public class SlidingUpPanelLayout extends ViewGroup {
	...
	public void setPanelHeightDp(int val) {
	...
	// return false;
	// }
	// update the functions "smoothSlideTo" and "onViewReleased" by the
	// following:
	boolean smoothSlideTo(float slideOffset, int velocity) {
		if (!mCanSlide) {
			// Nothing to do.
	...
	private boolean IS_FIXED_SIZE = false; // true for predefined height, false
											// for full screen
	private static final int FIXED_FULL_SIZE = 180; // the total height of your
													// view
	private static final float FIXED_OFFSET_LIMIT = 0.2f; // should be modified
															// according to
															// FIXED_FULL_SIZE
